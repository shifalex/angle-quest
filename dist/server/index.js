...
function getDraftSecret() {
	return "cca1dd3a-a2f5-422d-b556-ea556218a925";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6229d9cd-a919-4555-9386-a4acda65e17a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6229d9cd-a919-4555-9386-a4acda65e17a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6229d9cd-a919-4555-9386-a4acda65e17a",
		rootBoundaryId
	});
}
/**

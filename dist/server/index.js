...
function getDraftSecret() {
	return "8c6e2dc6-8b4a-4e1a-b8e8-987d3dd23177";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "de243d76-8963-447c-80ae-785cff4e0a83";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "de243d76-8963-447c-80ae-785cff4e0a83") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "de243d76-8963-447c-80ae-785cff4e0a83",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "f006b1e0-394c-4fb1-bc56-443a9178805c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e217f0d1-9c1e-40d7-9451-4dd230041578";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e217f0d1-9c1e-40d7-9451-4dd230041578") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e217f0d1-9c1e-40d7-9451-4dd230041578",
		rootBoundaryId
	});
}
/**

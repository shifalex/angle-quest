...
function getDraftSecret() {
	return "1eae2b1a-b90f-433e-a7cf-b0fd080cf044";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d6b25bc2-b443-4e58-83b3-be0eb22d1322";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d6b25bc2-b443-4e58-83b3-be0eb22d1322") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d6b25bc2-b443-4e58-83b3-be0eb22d1322",
		rootBoundaryId
	});
}
/**

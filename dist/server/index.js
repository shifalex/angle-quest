...
function getDraftSecret() {
	return "f99755a9-faa4-4667-b618-0a4c75291a0c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bf233780-c064-406b-b06a-539f69712f3b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bf233780-c064-406b-b06a-539f69712f3b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bf233780-c064-406b-b06a-539f69712f3b",
		rootBoundaryId
	});
}
/**

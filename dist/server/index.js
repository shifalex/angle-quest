...
function getDraftSecret() {
	return "ec6584ed-b87b-43dc-993d-8e69d06ca86c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b06b090e-159b-45fe-be00-955438969ee1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b06b090e-159b-45fe-be00-955438969ee1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b06b090e-159b-45fe-be00-955438969ee1",
		rootBoundaryId
	});
}
/**

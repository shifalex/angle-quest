...
function getDraftSecret() {
	return "7cfdaa1e-ebc0-40e3-9daa-f7bd7eb1037c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "41ddb8a8-9bf3-4475-837d-51983f8a94ca";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "41ddb8a8-9bf3-4475-837d-51983f8a94ca") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "41ddb8a8-9bf3-4475-837d-51983f8a94ca",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "a03bb229-97aa-4209-b36c-962497bb42f9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "aa2676c1-c23d-430c-bfc0-b1ef5f191b77";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "aa2676c1-c23d-430c-bfc0-b1ef5f191b77") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "aa2676c1-c23d-430c-bfc0-b1ef5f191b77",
		rootBoundaryId
	});
}
/**

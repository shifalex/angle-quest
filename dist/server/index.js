...
function getDraftSecret() {
	return "adb31b3c-801a-40b0-a045-fff4939c50f3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "54a4b056-d2b9-47e4-99c1-7455e3d2a18e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "54a4b056-d2b9-47e4-99c1-7455e3d2a18e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "54a4b056-d2b9-47e4-99c1-7455e3d2a18e",
		rootBoundaryId
	});
}
/**

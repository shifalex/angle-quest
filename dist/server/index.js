...
function getDraftSecret() {
	return "a1ccd4bf-e9f9-4f54-8a83-d52c0ec1eb2c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b13410b2-b1a3-40df-80dc-db4078a5a581";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b13410b2-b1a3-40df-80dc-db4078a5a581") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b13410b2-b1a3-40df-80dc-db4078a5a581",
		rootBoundaryId
	});
}
/**

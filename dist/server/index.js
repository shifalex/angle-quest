...
function getDraftSecret() {
	return "d137d65b-0c01-42c7-8802-4fdc2a437390";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cfe5e31d-308a-40cf-9116-f700006e5872";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cfe5e31d-308a-40cf-9116-f700006e5872") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cfe5e31d-308a-40cf-9116-f700006e5872",
		rootBoundaryId
	});
}
/**

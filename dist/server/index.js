...
function getDraftSecret() {
	return "35e1ac40-ace1-487e-b0f4-588bef042cc8";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "52a9b145-c305-4bcf-a129-5d592c3ef024";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "52a9b145-c305-4bcf-a129-5d592c3ef024") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "52a9b145-c305-4bcf-a129-5d592c3ef024",
		rootBoundaryId
	});
}
/**

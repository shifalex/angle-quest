...
function getDraftSecret() {
	return "2d34e4df-ce43-464d-9ac0-b405688215da";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "29854597-76e3-4800-88c0-a8d727636038";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "29854597-76e3-4800-88c0-a8d727636038") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "29854597-76e3-4800-88c0-a8d727636038",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "faa29c43-4cfd-4333-8636-c69916422eb7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2bbbddf3-5998-4612-b1cd-0405c83ba537";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2bbbddf3-5998-4612-b1cd-0405c83ba537") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2bbbddf3-5998-4612-b1cd-0405c83ba537",
		rootBoundaryId
	});
}
/**

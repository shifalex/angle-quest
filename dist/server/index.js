...
function getDraftSecret() {
	return "e3497f36-bdcb-4f46-9f75-742e51547c51";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b51ed2ff-1443-4884-83fe-5e21c594453b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b51ed2ff-1443-4884-83fe-5e21c594453b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b51ed2ff-1443-4884-83fe-5e21c594453b",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "5526b79d-44a0-44a8-a01b-a779aa38d7c8";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cf19fa1e-93ef-400f-9b87-dfe7a65c2fee";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cf19fa1e-93ef-400f-9b87-dfe7a65c2fee") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cf19fa1e-93ef-400f-9b87-dfe7a65c2fee",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "88a40f25-511e-4a1a-bd1b-7e307373cad3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5844e146-7bc0-46f3-9e79-ddf6a7e6fb26";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5844e146-7bc0-46f3-9e79-ddf6a7e6fb26") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5844e146-7bc0-46f3-9e79-ddf6a7e6fb26",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "c701baf5-1208-4b22-b6a4-71b9fcffbb09";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5ef217fe-cc1e-4f16-8ac7-2d26353a245f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5ef217fe-cc1e-4f16-8ac7-2d26353a245f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5ef217fe-cc1e-4f16-8ac7-2d26353a245f",
		rootBoundaryId
	});
}
/**

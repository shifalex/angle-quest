...
function getDraftSecret() {
	return "14ce33da-e789-4664-8744-a2ffcfd1281c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f36f9953-ca36-4032-a0b9-94cf9e0a7e0d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f36f9953-ca36-4032-a0b9-94cf9e0a7e0d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f36f9953-ca36-4032-a0b9-94cf9e0a7e0d",
		rootBoundaryId
	});
}
/**

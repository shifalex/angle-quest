...
function getDraftSecret() {
	return "45b70e37-117e-4ee3-a373-1e885797d7db";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1d2a46df-914b-48ec-9358-6a14d7f9bd9f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1d2a46df-914b-48ec-9358-6a14d7f9bd9f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1d2a46df-914b-48ec-9358-6a14d7f9bd9f",
		rootBoundaryId
	});
}
/**

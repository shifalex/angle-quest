...
function getDraftSecret() {
	return "3c822a5d-fd8a-45fb-8d34-e68b21924864";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f73d5c98-2aab-4ea2-a72b-ed498d592eb1";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f73d5c98-2aab-4ea2-a72b-ed498d592eb1") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f73d5c98-2aab-4ea2-a72b-ed498d592eb1",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "bb6454b1-04e6-42e7-b91d-f64794f1f09d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "96967718-6053-4456-a0bc-7f2574fa329f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "96967718-6053-4456-a0bc-7f2574fa329f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "96967718-6053-4456-a0bc-7f2574fa329f",
		rootBoundaryId
	});
}
/**

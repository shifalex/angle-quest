...
function getDraftSecret() {
	return "98dd2c3d-8b72-4a20-97c3-3f8c187ac463";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1145154d-4685-40b8-bf0b-6193af3c69d2";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1145154d-4685-40b8-bf0b-6193af3c69d2") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1145154d-4685-40b8-bf0b-6193af3c69d2",
		rootBoundaryId
	});
}
/**

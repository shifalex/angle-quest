...
function getDraftSecret() {
	return "537a443c-4a11-4c1d-aca6-80dd51ef477e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "643e1ec1-c13c-484b-9f4d-187fafd01bcb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "643e1ec1-c13c-484b-9f4d-187fafd01bcb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "643e1ec1-c13c-484b-9f4d-187fafd01bcb",
		rootBoundaryId
	});
}
/**

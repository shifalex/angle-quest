...
function getDraftSecret() {
	return "d182136e-d60d-4baf-845d-6c4c8b37feba";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "432094f4-9e0c-4698-9753-1ef8f5e6f4e2";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "432094f4-9e0c-4698-9753-1ef8f5e6f4e2") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "432094f4-9e0c-4698-9753-1ef8f5e6f4e2",
		rootBoundaryId
	});
}
/**

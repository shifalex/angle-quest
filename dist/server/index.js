...
function getDraftSecret() {
	return "f20113e9-1976-46ea-b9d8-21ab6a7317d3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d9548200-7653-4807-b806-90d2f2ed64c0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d9548200-7653-4807-b806-90d2f2ed64c0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d9548200-7653-4807-b806-90d2f2ed64c0",
		rootBoundaryId
	});
}
/**

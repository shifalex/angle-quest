...
function getDraftSecret() {
	return "73efaeb3-a448-493e-887f-37e1e5b18fec";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "caaf9ac2-813b-4f42-9fd2-eb37a1e9d2ca";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "caaf9ac2-813b-4f42-9fd2-eb37a1e9d2ca") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "caaf9ac2-813b-4f42-9fd2-eb37a1e9d2ca",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "8918523a-87d3-4ebb-868b-41686b5024b9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4243157a-08ba-4970-aaba-74e1b56f4f62";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4243157a-08ba-4970-aaba-74e1b56f4f62") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4243157a-08ba-4970-aaba-74e1b56f4f62",
		rootBoundaryId
	});
}
/**

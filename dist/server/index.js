...
function getDraftSecret() {
	return "d42d6441-ee33-4f04-8f6d-bca3a54f1462";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4a96b88c-9e2e-4a4e-bea8-a4a334d0aaf8";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4a96b88c-9e2e-4a4e-bea8-a4a334d0aaf8") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4a96b88c-9e2e-4a4e-bea8-a4a334d0aaf8",
		rootBoundaryId
	});
}
/**

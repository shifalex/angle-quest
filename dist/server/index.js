...
function getDraftSecret() {
	return "27f1534a-090f-4f65-8db1-db6732117bc6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "cff444f9-52de-4473-acf5-6e9f9878fa95";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "cff444f9-52de-4473-acf5-6e9f9878fa95") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "cff444f9-52de-4473-acf5-6e9f9878fa95",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "d7c54fd4-79ff-4d62-aa16-ab6a1cbcb6cf";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f3012d5e-9bd2-49c7-a545-fc330deaf067";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f3012d5e-9bd2-49c7-a545-fc330deaf067") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f3012d5e-9bd2-49c7-a545-fc330deaf067",
		rootBoundaryId
	});
}
/**

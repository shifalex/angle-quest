...
function getDraftSecret() {
	return "f672184d-f526-46e3-b33a-5d87c3cc0376";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1084110f-f011-406f-8c18-1835f03e9eb6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1084110f-f011-406f-8c18-1835f03e9eb6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1084110f-f011-406f-8c18-1835f03e9eb6",
		rootBoundaryId
	});
}
/**

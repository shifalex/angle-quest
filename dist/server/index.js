...
function getDraftSecret() {
	return "3574a9c7-8d9f-4bbf-b077-333bf1461d89";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2378e623-ee92-4a28-acc6-72ef9986cdff";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2378e623-ee92-4a28-acc6-72ef9986cdff") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2378e623-ee92-4a28-acc6-72ef9986cdff",
		rootBoundaryId
	});
}
/**

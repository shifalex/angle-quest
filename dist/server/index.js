...
function getDraftSecret() {
	return "b143e728-9f6f-4e79-9329-2438447b107f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a5c6786f-ec03-4aa6-8d1c-419cfdf17d06";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a5c6786f-ec03-4aa6-8d1c-419cfdf17d06") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a5c6786f-ec03-4aa6-8d1c-419cfdf17d06",
		rootBoundaryId
	});
}
/**

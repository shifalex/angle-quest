...
function getDraftSecret() {
	return "2400330b-415c-4888-879c-03ca793cba39";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9e7b9066-4db3-44de-9781-d8297f5ceaac";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9e7b9066-4db3-44de-9781-d8297f5ceaac") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9e7b9066-4db3-44de-9781-d8297f5ceaac",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "84174780-36b0-453f-ac9f-39009dd8b96f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d5c86d97-9e80-483a-9023-aa35c0dc0531";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d5c86d97-9e80-483a-9023-aa35c0dc0531") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d5c86d97-9e80-483a-9023-aa35c0dc0531",
		rootBoundaryId
	});
}
/**

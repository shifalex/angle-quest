...
function getDraftSecret() {
	return "741398d0-fbcd-4f67-95ba-0267321d29c9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5cce0c4d-0159-4f83-9f2c-30acb9bcf101";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5cce0c4d-0159-4f83-9f2c-30acb9bcf101") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5cce0c4d-0159-4f83-9f2c-30acb9bcf101",
		rootBoundaryId
	});
}
/**

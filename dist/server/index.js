...
function getDraftSecret() {
	return "d3021010-693e-4bed-961a-b869af16d3ad";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "871b5aa5-7f93-4927-8918-e1e91208dc78";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "871b5aa5-7f93-4927-8918-e1e91208dc78") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "871b5aa5-7f93-4927-8918-e1e91208dc78",
		rootBoundaryId
	});
}
/**

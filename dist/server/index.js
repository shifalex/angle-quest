...
function getDraftSecret() {
	return "c87b4a7e-bec2-4a66-99c6-91caa7af149f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c61663e5-8b0d-4cf2-90b0-e1fe5518a033";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c61663e5-8b0d-4cf2-90b0-e1fe5518a033") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c61663e5-8b0d-4cf2-90b0-e1fe5518a033",
		rootBoundaryId
	});
}
/**

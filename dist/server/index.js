...
function getDraftSecret() {
	return "c0bdcef0-d9b3-42e6-87a6-eaf3a2a9e911";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a9a0c65a-79ed-4f62-a6ba-7d20df8ba37f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a9a0c65a-79ed-4f62-a6ba-7d20df8ba37f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a9a0c65a-79ed-4f62-a6ba-7d20df8ba37f",
		rootBoundaryId
	});
}
/**

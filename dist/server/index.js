...
function getDraftSecret() {
	return "f0781b52-b28f-4ed7-8763-66d8c4cba965";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "602d5eb1-b9aa-44d5-9a3e-161cddb7bb1c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "602d5eb1-b9aa-44d5-9a3e-161cddb7bb1c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "602d5eb1-b9aa-44d5-9a3e-161cddb7bb1c",
		rootBoundaryId
	});
}
/**

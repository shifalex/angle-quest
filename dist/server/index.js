...
function getDraftSecret() {
	return "df8eb3ee-0cb3-4882-9d62-38dbe6dbc263";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ace336a5-713d-4b7f-bea3-14df6a340e2a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ace336a5-713d-4b7f-bea3-14df6a340e2a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ace336a5-713d-4b7f-bea3-14df6a340e2a",
		rootBoundaryId
	});
}
/**

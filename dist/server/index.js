...
function getDraftSecret() {
	return "0edf230d-2644-4ee5-82b4-ce8a239100bb";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "183c9040-3421-44f9-9466-079fd3073430";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "183c9040-3421-44f9-9466-079fd3073430") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "183c9040-3421-44f9-9466-079fd3073430",
		rootBoundaryId
	});
}
/**

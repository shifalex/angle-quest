...
function getDraftSecret() {
	return "cd6d6a20-0bd6-4850-ace8-479100785f56";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1b7e26ce-cd61-4486-be3f-cf8bfb89ae70";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1b7e26ce-cd61-4486-be3f-cf8bfb89ae70") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1b7e26ce-cd61-4486-be3f-cf8bfb89ae70",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "5d4862df-f133-410c-b614-ae454e9ab34c";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "723f596a-ca25-4ab9-832e-c26ccc46895d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "723f596a-ca25-4ab9-832e-c26ccc46895d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "723f596a-ca25-4ab9-832e-c26ccc46895d",
		rootBoundaryId
	});
}
/**

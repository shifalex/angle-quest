...
function getDraftSecret() {
	return "da682081-72c7-40dd-a2e7-8977160ddf05";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "108efe10-3c53-4396-bd5d-3d43ab5c5721";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "108efe10-3c53-4396-bd5d-3d43ab5c5721") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "108efe10-3c53-4396-bd5d-3d43ab5c5721",
		rootBoundaryId
	});
}
/**

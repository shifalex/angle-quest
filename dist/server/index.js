...
function getDraftSecret() {
	return "6207de17-c06e-4fae-ae4c-3a850b475c0e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f141a93a-4262-4352-9e34-197c4c2abe6f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f141a93a-4262-4352-9e34-197c4c2abe6f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f141a93a-4262-4352-9e34-197c4c2abe6f",
		rootBoundaryId
	});
}
/**

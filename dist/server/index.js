...
function getDraftSecret() {
	return "4cb3c4a2-184e-40c1-ad01-116c59fd0fdd";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "78b7b5e5-ee4e-4995-b4f7-6895987f92dd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "78b7b5e5-ee4e-4995-b4f7-6895987f92dd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "78b7b5e5-ee4e-4995-b4f7-6895987f92dd",
		rootBoundaryId
	});
}
/**

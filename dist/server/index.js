...
function getDraftSecret() {
	return "b31633f0-2db2-4b6e-b302-da4f4f226d96";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7b7d06f3-f02f-4a33-9f27-0085c98569cd";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7b7d06f3-f02f-4a33-9f27-0085c98569cd") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7b7d06f3-f02f-4a33-9f27-0085c98569cd",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "63363dbd-47a9-4c4a-a95f-3401aaa00b87";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "8129405b-0b77-4190-88e6-0cd1cbdc65cb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "8129405b-0b77-4190-88e6-0cd1cbdc65cb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "8129405b-0b77-4190-88e6-0cd1cbdc65cb",
		rootBoundaryId
	});
}
/**

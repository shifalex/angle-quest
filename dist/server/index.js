...
function getDraftSecret() {
	return "4728f4d0-246a-4c39-bc1f-4c354b83390f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4356c12a-ea46-4c20-8201-e30577c347bf";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4356c12a-ea46-4c20-8201-e30577c347bf") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4356c12a-ea46-4c20-8201-e30577c347bf",
		rootBoundaryId
	});
}
/**

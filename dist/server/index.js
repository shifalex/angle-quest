...
function getDraftSecret() {
	return "a8a32643-5838-491d-b46f-df9721002c37";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e090d84b-258e-4aa6-9914-5197110659d2";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e090d84b-258e-4aa6-9914-5197110659d2") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e090d84b-258e-4aa6-9914-5197110659d2",
		rootBoundaryId
	});
}
/**

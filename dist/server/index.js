...
function getDraftSecret() {
	return "c9129f7d-1dd4-43d1-8562-990340a05dba";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "520e8603-c966-46f0-b13e-d443c45392ff";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "520e8603-c966-46f0-b13e-d443c45392ff") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "520e8603-c966-46f0-b13e-d443c45392ff",
		rootBoundaryId
	});
}
/**

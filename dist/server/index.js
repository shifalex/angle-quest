...
function getDraftSecret() {
	return "b8681ada-9e74-4136-8988-1191c7d7d76d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9d1b4183-92a2-4da2-975c-071607142e55";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9d1b4183-92a2-4da2-975c-071607142e55") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9d1b4183-92a2-4da2-975c-071607142e55",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "b2950ea5-98b2-44e1-b956-e8f4bf0e5670";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "7681d9d0-6f3a-4b0d-aac0-4242ec46724c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "7681d9d0-6f3a-4b0d-aac0-4242ec46724c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "7681d9d0-6f3a-4b0d-aac0-4242ec46724c",
		rootBoundaryId
	});
}
/**

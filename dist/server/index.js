...
function getDraftSecret() {
	return "b579a11a-1424-4c97-8a2d-0a6e68fce120";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "c8bfb524-d71d-42f5-8515-9b75b62c30a6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "c8bfb524-d71d-42f5-8515-9b75b62c30a6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "c8bfb524-d71d-42f5-8515-9b75b62c30a6",
		rootBoundaryId
	});
}
/**

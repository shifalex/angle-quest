...
function getDraftSecret() {
	return "e4df8ea4-3179-4bb6-be48-953d9dd72f18";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2e967240-aac2-40f5-ae56-75aaaed387c0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2e967240-aac2-40f5-ae56-75aaaed387c0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2e967240-aac2-40f5-ae56-75aaaed387c0",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "c173b167-7ce9-412a-ac73-e3ea47a25466";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e34f2eaf-2789-4e97-be87-8e5f8407bb94";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e34f2eaf-2789-4e97-be87-8e5f8407bb94") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e34f2eaf-2789-4e97-be87-8e5f8407bb94",
		rootBoundaryId
	});
}
/**

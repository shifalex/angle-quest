...
function getDraftSecret() {
	return "dd93c5db-a384-4c16-be38-18c06171d218";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "48251d58-d971-434c-96d8-0578bc865b69";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "48251d58-d971-434c-96d8-0578bc865b69") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "48251d58-d971-434c-96d8-0578bc865b69",
		rootBoundaryId
	});
}
/**

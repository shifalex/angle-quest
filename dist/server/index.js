...
function getDraftSecret() {
	return "b8d7107d-e9fd-4f49-a82c-63f04db05b1f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6e9ef4d8-aaf5-4aba-bfbc-613e76f03b69";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6e9ef4d8-aaf5-4aba-bfbc-613e76f03b69") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6e9ef4d8-aaf5-4aba-bfbc-613e76f03b69",
		rootBoundaryId
	});
}
/**

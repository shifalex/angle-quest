...
function getDraftSecret() {
	return "e2b809bb-aa5d-46b7-8e90-e5b803e35304";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e85e0872-8668-45f9-b2b9-824d1b80bc1f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e85e0872-8668-45f9-b2b9-824d1b80bc1f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e85e0872-8668-45f9-b2b9-824d1b80bc1f",
		rootBoundaryId
	});
}
/**

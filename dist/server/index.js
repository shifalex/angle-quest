...
function getDraftSecret() {
	return "f9bfe863-2952-4d5a-b87e-6662f1bd4b1b";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "dc0cca9c-dff8-4170-8389-67418d19cffe";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "dc0cca9c-dff8-4170-8389-67418d19cffe") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "dc0cca9c-dff8-4170-8389-67418d19cffe",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "af2b4d56-420a-4bdc-9ee9-5709151dcd80";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "9237c89f-fcbf-4fdc-bd16-a56cd64bd3f0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "9237c89f-fcbf-4fdc-bd16-a56cd64bd3f0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "9237c89f-fcbf-4fdc-bd16-a56cd64bd3f0",
		rootBoundaryId
	});
}
/**

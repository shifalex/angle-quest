...
function getDraftSecret() {
	return "135bdab8-fb50-4256-876e-498c52445e86";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "808c7e5b-0777-4aa1-b625-e2cfbe30e870";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "808c7e5b-0777-4aa1-b625-e2cfbe30e870") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "808c7e5b-0777-4aa1-b625-e2cfbe30e870",
		rootBoundaryId
	});
}
/**

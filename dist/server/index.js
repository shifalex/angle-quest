...
function getDraftSecret() {
	return "112797e1-56c8-42f4-91a4-0793cb31a6dc";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b241d4b0-9167-4aac-84f0-f5565d8b21a4";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b241d4b0-9167-4aac-84f0-f5565d8b21a4") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b241d4b0-9167-4aac-84f0-f5565d8b21a4",
		rootBoundaryId
	});
}
/**

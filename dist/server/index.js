...
function getDraftSecret() {
	return "a6c1424d-27f6-4b62-b560-34ae50db9180";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ef630aff-e5d1-4372-be69-6670fc0baa67";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ef630aff-e5d1-4372-be69-6670fc0baa67") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ef630aff-e5d1-4372-be69-6670fc0baa67",
		rootBoundaryId
	});
}
/**

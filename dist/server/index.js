...
function getDraftSecret() {
	return "35bd38cd-af5e-468d-a516-50c63b326ad0";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "402c165b-b1de-4769-a117-371713e5333e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "402c165b-b1de-4769-a117-371713e5333e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "402c165b-b1de-4769-a117-371713e5333e",
		rootBoundaryId
	});
}
/**

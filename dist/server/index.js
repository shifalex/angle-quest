...
function getDraftSecret() {
	return "7c492fff-f6a9-4935-a820-b2baa0d623e1";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "1a169380-44fb-472e-952c-7c23a9e96a4d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "1a169380-44fb-472e-952c-7c23a9e96a4d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "1a169380-44fb-472e-952c-7c23a9e96a4d",
		rootBoundaryId
	});
}
/**

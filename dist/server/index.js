...
function getDraftSecret() {
	return "9659850e-8bd8-4c31-8837-3e906a7789e2";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6e122b3e-8196-449d-8533-02ea0a81df60";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6e122b3e-8196-449d-8533-02ea0a81df60") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6e122b3e-8196-449d-8533-02ea0a81df60",
		rootBoundaryId
	});
}
/**

...
function getDraftSecret() {
	return "79c394b9-b5e7-4a42-81d9-7eb937aa9f8a";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "4dcd6a58-a5c0-4025-8bce-3a4269e4eb0d";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "4dcd6a58-a5c0-4025-8bce-3a4269e4eb0d") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "4dcd6a58-a5c0-4025-8bce-3a4269e4eb0d",
		rootBoundaryId
	});
}
/**
